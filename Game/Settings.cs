...
namespace Torq2
{
	public static class Settings
	{
		...
		public const float SCREEN_RATIO = (float) SCREEN_WIDTH / (float) SCREEN_HEIGHT;

		public const int SCREEN_WIDTH_DIV_2 = SCREEN_WIDTH / 2;
		public const int SCREEN_HEIGHT_DIV_2 = SCREEN_HEIGHT / 2;
		...
		/// </summary>
		public const short GRID_SIZE_N = 255; // 2^k - 1, and max of 1023
