...
namespace Torq2.Terrain
{
	public class Block : SceneObject
	{
		...
		public Block(int nGridSpacing, Vector2 tGridSpaceOffset, Vector2 tOffset)
		{
		...
		public void Update(Vector2 tLevelMinPosition)
		{
			...
			m_tPositionMin = new Vector3(tWorldPosition.X, tWorldPosition.Y, -1.0f);

			int nBlockSizeWorldSpace = Settings.BLOCK_SIZE_M_MINUS_ONE * m_nGridSpacing;
			m_tPositionMax = new Vector3(tWorldPosition.X + nBlockSizeWorldSpace, tWorldPosition.Y + nBlockSizeWorldSpace, 100.0f);
		}
